...
class ConsoleLogger {
	...
	async sendToDiscord(content, immediate = false) {
		...
		const payload = {
			username: "ardelagi",
			avatar_url: "https://media.discordapp.net/attachments/1351582627072577546/1354602126684196944/20250318_073124_0000.png?ex=67e5e30a&is=67e4918a&hm=df4cc5615fc4209aff8990f18806e293b30f520696301cf99354e9f386720ac4&",
			content: "```\n" + content + "\n```",
		};
