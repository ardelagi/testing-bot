...
function handleLogs(client) {
    ...
    client.on("guildMemberNicknameUpdate", (member, oldNickname, newNickname) => {
        try {
            ...
            const embed = new EmbedBuilder()
            .setTitle(`${client.user.username} Logging system ${client.config.arrowEmoji}`)
            .setDescription(`__Nickname Changed__`)
            .setColor('Blue')
            .setTimestamp()
            .setThumbnail(client.user.avatarURL())
            .setAuthor({ name: `Logging System ${client.config.devBy}`})
    ...
    client.on("guildBoostLevelUp", (guild, oldLevel, newLevel) => {
        ...
        if (guild === null) return;
            ...
            const embed = new EmbedBuilder()
            .setTitle(`${client.user.username} Logging system ${client.config.arrowEmoji}`)
            .setDescription(`__Server Boost Level Up__`)
            .setColor('Pink')
            .setTimestamp()
    ...
    client.on("guildBoostLevelDown", (guild, oldLevel, newLevel) => {
        ...
        if (guild === null) return;
            ...
            const embed = new EmbedBuilder()
            .setTitle(`${client.user.username} Logging system ${client.config.arrowEmoji}`)
            .setDescription(`__Server Boost Level Down__`)
            .setColor('Pink')
            .setTimestamp()
    ...
    client.on("guildBannerAdd", (guild, bannerURL) => {
        ...
        if (guild === null) return;
            ...
            const embed = new EmbedBuilder()
            .setTitle(`${client.user.username} Logging system ${client.config.arrowEmoji}`)
            .setDescription(`__Guild Banner Added__`)
            .setColor('Green')
    ...
    client.on("rolePositionUpdate", (role, oldPosition, newPosition) => {
        ...
        if (role.guild === null) return;
            ...
            const embed = new EmbedBuilder()
            .setTitle(`${client.user.username} Logging system ${client.config.arrowEmoji}`)
            .setDescription(`__Role Position Updated__`)
            .setColor('Red')
            .addFields({ name: `Role`, value: `> ${role}`})
    ...
    client.on("rolePermissionsUpdate", (role, oldPermissions, newPermissions) => {
        ...
        if (role.guild === null) return;
            ...
            const embed = new EmbedBuilder()
            .setTitle(`${client.user.username} Logging system ${client.config.arrowEmoji}`)
            .setDescription(`__Role Permissions Updated__`)
            .setColor('Red')
            .addFields({ name: `Role`, value: `> ${role}`})
    ...
    client.on("guildBanAdd", ({guild, user}) => {
        ...
        if (guild === null) return;
            ...
            const embed = new EmbedBuilder()
            .setTitle(`${client.user.username} Logging system ${client.config.arrowEmoji}`)
            .setDescription(`__User Banned__`)
            .setColor('Red')
            .setTimestamp()
    ...
    client.on("guildBanRemove", ({guild, user}) => {
        ...
        if (guild === null) return;
            ...
            const embed = new EmbedBuilder()
            .setTitle(`${client.user.username} Logging system ${client.config.arrowEmoji}`)
            .setDescription(`__User Unbanned__`)
            .setColor('Green')
            .setTimestamp()
            .addFields({ name: `Member`, value: `> ${user}`})
            .setThumbnail(client.user.avatarURL())
...
client.on("guildMemberUpdate", (oldMember, newMember) => {
    try {
        ...
        if (oldMember.user.avatar !== newMember.user.avatar) {
            const embed = new EmbedBuilder()
                .setTitle(`${client.user.username} Logging system ${client.config.arrowEmoji}`)
                .setDescription(`__Member Avatar Updated__`)
                .setColor('Blue')
                .setTimestamp()
                .addFields({ name: `Member`, value: `> ${newMember.user}` })
                .addFields({ name: `Old Avatar`, value: `> [Old Avatar](${oldMember.user.displayAvatarURL()})` })
                .addFields({ name: `New Avatar`, value: `> [New Avatar](${newMember.user.displayAvatarURL()})` })
                .setThumbnail(client.user.avatarURL())
                .setAuthor({ name: `Logging System ${client.config.devBy}` })
                .setFooter({ text: `Avatar Updated` });

            return send_log(newMember.guild.id, embed);
        }
    } catch (err) {
        client.logs.error('[AUDIT_LOGGING] Error logging member avatar update.');
    }
});
